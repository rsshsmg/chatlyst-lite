...
class DoctorScheduleTest extends TestCase
{
    ...
    public function test_public_page_shows_doctor()
    {
        ...
        $doc = Doctor::create(['name' => 'Dr. Budi', 'title' => 'Sp.PD', 'specialization_id' => $spec->id, 'status' => 'available']);
        DoctorSchedule::create(['doctor_id' => $doc->id, 'day_of_week' => 'Monday', 'start_time' => '09:00:00', 'end_time' => '12:00:00']);
